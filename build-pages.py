...
<section class="hero" id="film">
  <div class="stage">
    ...
    <div class="bands" id="bands">
      ...
      <div class="band e-drift" data-a="0" data-b="0.16">
        <div class="bandin">
          <span class="kick">iStore Tech · Dakar</span>
          <p class="htitle" data-split="word">Neuf, scellé, livré demain.</p>
        </div>
      </div>

      <div class="band e-scatter" data-a="0.29" data-b="0.47" data-spread="0.5">
        <div class="bandin">
          <p class="htitle sm" data-split="char">Et pas seulement le téléphone.</p>
        </div>
      </div>

      <div class="band e-punch" data-a="0.66" data-b="0.80">
        <div class="bandin">
          <p class="htitle sm" data-split="word">PlayStation, Switch, MacBook.</p>
        </div>
      </div>

      <div class="band e-rise live" data-a="0.80" data-b="1" data-ramp="0.05">
        <div class="bandin">
          <p class="htitle set" data-split="word">Tu paies quand tu l'as en main.</p>
          <p class="hsub">Livraison 24h. Wave, Orange Money ou espèces à la réception.</p>
          <div class="hrow">
